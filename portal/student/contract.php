<?php
    ...
    $query_get_employee = mysqli_query($connection, "SELECT * FROM contracts c, users u WHERE c.user_id = u.username AND c.user_id = '".$user_login_id."'");
    ...
    if(isset($_POST["enable-button"])){
        ...
        $query_existing_contract = mysqli_query($connection, "SELECT * FROM `contracts` WHERE `user_id` = '".$user_login_id."'");

        if($row = mysqli_fetch_array($query_existing_contract)){
            $query_update_contract = "UPDATE `contracts` SET `contract_id`='".$con_id."',`drivers_license`='".$drivers_license."',`employer`='".$employer_name."',`employer_address`='".$employer_address."' WHERE `user_id` = '".$user_login_id."'";                       
            ...
            $query_insert_contrator = "INSERT INTO `contracts`(`contract_id`, `user_id`, `drivers_license`, `employer`, `employer_address`, `status`) VALUES ('".$con_id."','".$user_login_id."','".$drivers_license."','".$employer_name."','".$employer_address."','Active')";                       
